function Schedule(CONFIG) {
    ...
    schedule.loadChosenTab = function() {
        ...
        if (schedule.chosenTab == 'favorites') {
            ...
            schedule.addCaptionOverline('<p class="overline"><i class="fa fa-cc"></i> indicates sessions with a live stenographer. Other sessions offer automated captioning.</p>');
